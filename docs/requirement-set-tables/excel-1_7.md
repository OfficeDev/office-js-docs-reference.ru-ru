...
||[showAllFieldButtons](/javascript/api/excel/excel.chart#showallfieldbuttons)|Указывает, следует ли отображать все кнопки полей на сводная диаграмма.|
|[ChartAreaFormat](/javascript/api/excel/excel.chartareaformat)|[border](/javascript/api/excel/excel.chartareaformat#border)|Представляет формат границы области диаграммы, который включает цвет, строки и вес.|
|[ChartAxes](/javascript/api/excel/excel.chartaxes)|[getItem(type: Excel.ChartAxisType, group?: Excel.ChartAxisGroup)](/javascript/api/excel/excel.chartaxes#getitem-type--group-)|Возвращает указанную ось, определенную по типу и группе.|
|[ChartAxis](/javascript/api/excel/excel.chartaxis)|[baseTimeUnit](/javascript/api/excel/excel.chartaxis#basetimeunit)|Указывает базовую единицу для указанной оси категорий.|
...
||[majorTickMark](/javascript/api/excel/excel.chartaxis#majortickmark)|Указывает тип основной тик-метки для указанной оси.|
||[majorTimeUnitScale](/javascript/api/excel/excel.chartaxis#majortimeunitscale)|Указывает значение масштабирования основных единиц единиц для оси категорий, если свойству CategoryType задано значение TimeScale.|
||[minorTickMark](/javascript/api/excel/excel.chartaxis#minortickmark)|Указывает тип второстепенной тик-метки для указанной оси.|
||[minorTimeUnitScale](/javascript/api/excel/excel.chartaxis#minortimeunitscale)|Указывает незначительное значение масштабирования единиц единицы для оси категории, если свойству CategoryType задано значение TimeScale.|
||[axisGroup](/javascript/api/excel/excel.chartaxis#axisgroup)|Указывает группу для указанной оси.|
||[customDisplayUnit](/javascript/api/excel/excel.chartaxis#customdisplayunit)|Указывает значение отображаемой единицы пользовательской оси.|
||[height](/javascript/api/excel/excel.chartaxis#height)|Указывает высоту оси диаграммы (в пунктах).|
||[left](/javascript/api/excel/excel.chartaxis#left)|Указывает расстояние (в пунктах) от левого края оси до левого края области диаграммы.|
||[top](/javascript/api/excel/excel.chartaxis#top)|Указывает расстояние (в пунктах) от верхнего края оси до верхней части области диаграммы.|
||[тип](/javascript/api/excel/excel.chartaxis#type)|Указывает тип оси.|
||[width](/javascript/api/excel/excel.chartaxis#width)|Указывает ширину оси диаграммы (в пунктах).|
||[reversePlotOrder](/javascript/api/excel/excel.chartaxis#reverseplotorder)|Указывает, занося ли в Excel точки данных от последнего к первому.|
||[scaleType](/javascript/api/excel/excel.chartaxis#scaletype)|Указывает тип шкалы оси значений.|
...
||[setCustomDisplayUnit(value: number)](/javascript/api/excel/excel.chartaxis#setcustomdisplayunit-value-)|Задает отображаемую единицу измерения оси в виде настраиваемого значения.|
||[showDisplayUnitLabel](/javascript/api/excel/excel.chartaxis#showdisplayunitlabel)|Указывает, отображается ли метка отображаемой единицы оси.|
||[tickLabelPosition](/javascript/api/excel/excel.chartaxis#ticklabelposition)|Указывает положение подписей тактов на указанной оси.|
||[tickLabelSpacing](/javascript/api/excel/excel.chartaxis#ticklabelspacing)|Указывает число категорий или рядов между подписями тактовой метки.|
||[tickMarkSpacing](/javascript/api/excel/excel.chartaxis#tickmarkspacing)|Указывает число категорий или рядов между тактами.|
||[visible](/javascript/api/excel/excel.chartaxis#visible)|Указывает, видима ли ось.|
...
||[separator](/javascript/api/excel/excel.chartdatalabel#separator)|Строка, представляющая разделитель для метки данных на диаграмме.|
||[showBubbleSize](/javascript/api/excel/excel.chartdatalabel#showbubblesize)|Указывает, отображается ли размер пузырьков метки данных.|
...
||[showLegendKey](/javascript/api/excel/excel.chartdatalabel#showlegendkey)|Указывает, отображается ли ключ легенды метки данных.|
||[showPercentage](/javascript/api/excel/excel.chartdatalabel#showpercentage)|Указывает, отображается ли процент меток данных.|
||[showSeriesName](/javascript/api/excel/excel.chartdatalabel#showseriesname)|Указывает, отображается ли имя ряда меток данных.|
...
|[ChartLegend](/javascript/api/excel/excel.chartlegend)|[height](/javascript/api/excel/excel.chartlegend#height)|Указывает высоту легенды на диаграмме (в пунктах).|
||[left](/javascript/api/excel/excel.chartlegend#left)|Указывает левый (в пунктах) обозначения на диаграмме.|
...
||[showShadow](/javascript/api/excel/excel.chartlegend#showshadow)|Указывает, имеет ли легенды тень на диаграмме.|
||[top](/javascript/api/excel/excel.chartlegend#top)|Указывает верх легенды диаграммы.|
||[width](/javascript/api/excel/excel.chartlegend#width)|Указывает ширину легенды на диаграмме (в пунктах).|
...
||[markerBackgroundColor](/javascript/api/excel/excel.chartpoint#markerbackgroundcolor)|HtmL-код цвета фона маркера точки данных (например, #FF0000 представляет красный цвет).|
||[markerForegroundColor](/javascript/api/excel/excel.chartpoint#markerforegroundcolor)|HtmL-код цвета для цвета переднего плана маркера точки данных (например, #FF0000 представляет красный цвет).|
...
|[ChartPointFormat](/javascript/api/excel/excel.chartpointformat)|[border](/javascript/api/excel/excel.chartpointformat#border)|Представляет формат границы точки данных диаграммы, которая включает сведения о цвете, стиле и весе.|
...
||[filtered](/javascript/api/excel/excel.chartseries#filtered)|Указывает, фильтруется ли ряд.|
||[gapWidth](/javascript/api/excel/excel.chartseries#gapwidth)|Представляет ширину разрывов рядов диаграммы.|
||[hasDataLabels](/javascript/api/excel/excel.chartseries#hasdatalabels)|Указывает, есть ли в ряду метки данных.|
||[markerBackgroundColor](/javascript/api/excel/excel.chartseries#markerbackgroundcolor)|Указывает цвет фона маркеров для ряда диаграммы.|
||[markerForegroundColor](/javascript/api/excel/excel.chartseries#markerforegroundcolor)|Указывает цвет переднего плана маркеров для ряда диаграммы.|
||[markerSize](/javascript/api/excel/excel.chartseries#markersize)|Указывает размер маркера для ряда диаграммы.|
||[markerStyle](/javascript/api/excel/excel.chartseries#markerstyle)|Указывает стиль маркера ряда диаграммы.|
||[plotOrder](/javascript/api/excel/excel.chartseries#plotorder)|Указывает порядок диаграммы в группе диаграммы.|
||[trendlines](/javascript/api/excel/excel.chartseries#trendlines)|Коллекция линий тренда в ряду.|
||[setBubbleSizes(sourceData: Range)](/javascript/api/excel/excel.chartseries#setbubblesizes-sourcedata-)|Задает размеры пузырьков для ряда диаграммы.|
||[setValues(sourceData: Range)](/javascript/api/excel/excel.chartseries#setvalues-sourcedata-)|Задает значения для ряда диаграммы.|
||[setXAxisValues(sourceData: Range)](/javascript/api/excel/excel.chartseries#setxaxisvalues-sourcedata-)|Задает значения оси X для ряда диаграммы.|
||[showShadow](/javascript/api/excel/excel.chartseries#showshadow)|Указывает, имеет ли ряд тени.|
||[smooth](/javascript/api/excel/excel.chartseries#smooth)|Указывает, является ли ряд плавным.|
...
|[ChartTitle](/javascript/api/excel/excel.charttitle)|[getSubstring(start: number, length: number)](/javascript/api/excel/excel.charttitle#getsubstring-start--length-)|Получите подстроку заголовка диаграммы.|
...
||[left](/javascript/api/excel/excel.charttitle#left)|Указывает расстояние (в пунктах) от левого края заголовка диаграммы до левого края области диаграммы.|
...
||[width](/javascript/api/excel/excel.charttitle#width)|Указывает ширину заголовка диаграммы (в пунктах).|
...
||[top](/javascript/api/excel/excel.charttitle#top)|Указывает расстояние (в пунктах) от верхнего края заголовка диаграммы до верхнего края области диаграммы.|
...
|[ChartTitleFormat](/javascript/api/excel/excel.charttitleformat)|[border](/javascript/api/excel/excel.charttitleformat#border)|Представляет формат границы заголовка диаграммы, который включает цвет, строки и вес.|
...
||[intercept](/javascript/api/excel/excel.charttrendline#intercept)|Представляет значение отсекаемого отрезка линии тренда.|
||[movingAveragePeriod](/javascript/api/excel/excel.charttrendline#movingaverageperiod)|Представляет период линии тренда диаграммы.|
||[name](/javascript/api/excel/excel.charttrendline#name)|Представляет имя линии тренда.|
||[polynomialOrder](/javascript/api/excel/excel.charttrendline#polynomialorder)|Представляет порядок линии тренда диаграммы.|
||[format](/javascript/api/excel/excel.charttrendline#format)|Представляет форматирование линии тренда диаграммы.|
||[тип](/javascript/api/excel/excel.charttrendline#type)|Представляет тип линии тренда диаграммы.|
...
||[тип](/javascript/api/excel/excel.customproperty#type)|Тип значения, используемого для настраиваемого свойства.|
...
|[DocumentProperties](/javascript/api/excel/excel.documentproperties)|[author](/javascript/api/excel/excel.documentproperties#author)|Автор книги.|
||[category](/javascript/api/excel/excel.documentproperties#category)|Категория книги.|
...
||[keywords](/javascript/api/excel/excel.documentproperties#keywords)|Ключевые слова книги.|
...
||[custom](/javascript/api/excel/excel.documentproperties#custom)|Получает коллекцию настраиваемых свойств книги.|
...
|[NamedItem](/javascript/api/excel/excel.nameditem)|[formula](/javascript/api/excel/excel.nameditem#formula)|Формула именоваемого элемента.|
...
|[NamedItemArrayValues](/javascript/api/excel/excel.nameditemarrayvalues)|[types](/javascript/api/excel/excel.nameditemarrayvalues#types)|Представляет типы для каждого элемента в именоваемом массиве элементов|
...
||[getImage()](/javascript/api/excel/excel.range#getimage--)|Отрисовка диапазона в качестве изображения png в коде base64.|
...
||[hyperlink](/javascript/api/excel/excel.range#hyperlink)|Представляет гиперссылки для текущего диапазона.|
||[numberFormatLocal](/javascript/api/excel/excel.range#numberformatlocal)|Представляет код формата номера Excel для заданного диапазона в зависимости от языковых параметров пользователя.|
...
|[RangeFormat](/javascript/api/excel/excel.rangeformat)|[textOrientation](/javascript/api/excel/excel.rangeformat#textorientation)|Ориентация текста всех ячеек в диапазоне.|
||[useStandardHeight](/javascript/api/excel/excel.rangeformat#usestandardheight)|Определяет, равна ли высота строки `Range` объекта стандартной высоте листа.|
||[useStandardWidth](/javascript/api/excel/excel.rangeformat#usestandardwidth)|Указывает, равна ли ширина столбца `Range` объекта стандартной ширине листа.|
...
||[documentReference](/javascript/api/excel/excel.rangehyperlink#documentreference)|Представляет объект ссылки на документ для гиперссылки.|
...
||[includeBorder](/javascript/api/excel/excel.style#includeborder)|Указывает, содержит ли стиль свойства границы Color, ColorIndex, LineStyle и Weight.|
||[includeFont](/javascript/api/excel/excel.style#includefont)|Указывает, включает ли стиль свойства шрифтов Background, Bold, Color, ColorIndex, FontStyle, Italic, Name, Size, Strikethrough, Subscript, Superscript и Underline.|
||[includeNumber](/javascript/api/excel/excel.style#includenumber)|Указывает, включает ли стиль свойство NumberFormat.|
||[includePatterns](/javascript/api/excel/excel.style#includepatterns)|Указывает, включает ли стиль внутренние свойства Color, ColorIndex, InvertIfNegative, Pattern, PatternColor и PatternColorIndex.|
...
||[shrinkToFit](/javascript/api/excel/excel.style#shrinktofit)|Указывает, сжимается ли текст автоматически в доступной ширине столбца.|
||[verticalAlignment](/javascript/api/excel/excel.style#verticalalignment)|Указывает вертикальное выравнивание для стиля.|
||[wrapText](/javascript/api/excel/excel.style#wraptext)|Указывает, является ли Excel переносом текста в объект.|
...
|[Table](/javascript/api/excel/excel.table)|[onChanged](/javascript/api/excel/excel.table#onchanged)|Возникает, когда данные в ячейках меняются в определенной таблице.|
||[onSelectionChanged](/javascript/api/excel/excel.table#onselectionchanged)|Возникает, когда выбор изменяется в определенной таблице.|
...
|[TableCollection](/javascript/api/excel/excel.tablecollection)|[onChanged](/javascript/api/excel/excel.tablecollection#onchanged)|Возникает при изменениях данных в любой таблице книги или на таблице.|
...
||[isInsideTable](/javascript/api/excel/excel.tableselectionchangedeventargs#isinsidetable)|Указывает, находится ли выделение внутри таблицы, адрес будет бесполезным, если для IsInsideTable задано false.|
...
||[styles](/javascript/api/excel/excel.workbook#styles)|Представляет коллекцию стилей, связанных с книгой.|
...
||[protected](/javascript/api/excel/excel.workbookprotection#protected)|Указывает, защищена ли книга.|
...
||[freezePanes](/javascript/api/excel/excel.worksheet#freezepanes)|Получает объект, который можно использовать для управления застывшие области на этом сайте.|
||[onActivated](/javascript/api/excel/excel.worksheet#onactivated)|Возникает при активации таблицы.|
||[onChanged](/javascript/api/excel/excel.worksheet#onchanged)|Возникает, когда данные меняются на определенном таблице.|
||[onDeactivated](/javascript/api/excel/excel.worksheet#ondeactivated)|Происходит, когда таблица деактивирована.|
||[onSelectionChanged](/javascript/api/excel/excel.worksheet#onselectionchanged)|Возникает, когда выбор изменяется на определенном сайте.|
...
||[standardWidth](/javascript/api/excel/excel.worksheet#standardwidth)|Указывает стандартную (по умолчанию) ширину всех столбцов на этом документе.|
||[tabColor](/javascript/api/excel/excel.worksheet#tabcolor)|Цвет вкладки для таблицы.|
...
||[onDeactivated](/javascript/api/excel/excel.worksheetcollection#ondeactivated)|Возникает, когда любой рабочий день в книге деактивирован.|
...
|[WorksheetFreezePanes](/javascript/api/excel/excel.worksheetfreezepanes)|[freezeAt(frozenRange: строка \| range)](/javascript/api/excel/excel.worksheetfreezepanes#freezeat-frozenrange-)|Задает закрепленные ячейки в представлении активного листа.|
||[freezeColumns(count?: number)](/javascript/api/excel/excel.worksheetfreezepanes#freezecolumns-count-)|Зависает первый столбец или столбцы на месте.|
||[freezeRows(count?: number)](/javascript/api/excel/excel.worksheetfreezepanes#freezerows-count-)|Зависает верхняя строка или строки на месте.|
...
||[unfreeze()](/javascript/api/excel/excel.worksheetfreezepanes#unfreeze--)|Удаляет все закрепленные области в листе.|
