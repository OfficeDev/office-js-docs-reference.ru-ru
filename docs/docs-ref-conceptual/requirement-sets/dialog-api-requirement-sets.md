# <a name="dialog-api-requirement-sets"></a>Наборы обязательных элементов Dialog API
...
|  Набор обязательных элементов  | Office 2013 для Windows | Office 2016 для Windows (установка с помощью MSI)   | Office 365 для Windows (C2R установок)   |  Office 365 для iPad  |  Office 365 для Mac  | Office Online  |  Office Online Server  |
|:-----|-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
1.1 API диалоговое окно является первой версии API-интерфейса. Для получения дополнительных сведений об API приведены в разделе Справочник по [API диалогового окна](/javascript/api/office/office.ui) .
