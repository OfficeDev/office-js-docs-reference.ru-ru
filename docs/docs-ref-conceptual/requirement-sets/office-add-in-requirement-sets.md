...
| DialogApi | В разделе [наборов требований API диалогового окна](dialog-api-requirement-sets.md). | UI.messageParent<br>UI.displayDialogAsync<br>UI.closeContainer<br>UI.Dialog |
