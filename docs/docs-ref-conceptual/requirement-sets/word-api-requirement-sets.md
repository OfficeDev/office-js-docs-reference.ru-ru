...
Надстройки Word выполните в разных версиях Office, включая Office 2016 для Windows, Office для iPad, Office для Mac и Office Online. В следующей таблице перечислены наборы требований Word ведущие приложения Office, которые поддерживают числа, set и построения или версии требования для этих приложений.
