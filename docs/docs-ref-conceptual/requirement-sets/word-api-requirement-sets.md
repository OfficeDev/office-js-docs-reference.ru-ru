...
Надстройки Word выполните для нескольких версий Office, включая Office 2016 или более поздней версии для Windows, Office для iPad, Office для Mac и Office Online. В следующей таблице перечислены наборы требований Word ведущие приложения Office, которые поддерживают числа, set и построения или версии требования для этих приложений.

> [!NOTE]
> Для наборов требований, которые помечены как бета-версии, используйте указанный (или более поздней версии) версии программного обеспечения Office и бета-версию библиотеки сети CDN: https://appsforoffice.microsoft.com/lib/beta/hosted/office.js.
> 
> Операции, отсутствует в списке как обычно бета-версии доступны и могут продолжить использовать CDN рабочей библиотеки:https://appsforoffice.microsoft.com/lib/1/hosted/office.js
...
> [!NOTE]
> Номер сборки 2016 Office установлен с помощью MSI — 16.0.4266.1001. Эта версия содержит только наборы требований WordApi 1.1.
...
|[body](/javascript/api/word/word.body)|_Метод_ > insertTable (значение rowCount: число, columnCount: номеров, insertLocation: InsertLocation значения: строка)|Вставляет таблицу с указанным количеством строк и столбцов. Возможные значения insertLocation: Start и End.|1.3|
|[breaktype](/javascript/api/word/word.breaktype)|_Отношения_ > разрывов|Указывает форму разрыв: строки, страницы или тип раздела. Только для чтения.|1.3|
...
|[contentControl](/javascript/api/word/word.contentcontrol)|_Метод_ > insertTable (значение rowCount: число, columnCount: номеров, insertLocation: InsertLocation значения: строка)|Вставляет таблицу с указанным количеством строк и столбцов в элемент управления содержимым или рядом с ним. Возможные значения insertLocation: Start, End, Before и After.|1.3|
|[contentControl](/javascript/api/word/word.contentcontrol)|_Метод_ > Разделение (разделители: строка, multiParagraphs: bool trimDelimiters: bool trimSpacing: bool)|Разделяет элемент управления содержимым на дочерние диапазоны с помощью разделителей.|1.3|
...
|[customProperty](/javascript/api/word/word.customproperty)|_Связь_ > type|Возвращает значение типа настраиваемого свойства. Только для чтения.|1.3|
...
|[customPropertyCollection](/javascript/api/word/word.custompropertycollection)|_Метод_ > задать (ключ: строковое значение: объектов)|Создает или задает настраиваемое свойство.|1.3|
...
|[documentProperties](/javascript/api/word/word.documentproperties)|_Свойство_ > security|Получает защиты документа. Только для чтения.|1.3|
...
|[documentProperties](/javascript/api/word/word.documentproperties)|_Связь_ > creationDate|Получает дату создания документа. Только для чтения.|1.3|
...
|[documentProperties](/javascript/api/word/word.documentproperties)|_Связь_ > lastPrintDate|Получает дату последнего печати документа. Только для чтения.|1.3|
|[documentProperties](/javascript/api/word/word.documentproperties)|_Связь_ > lastSaveTime|Возвращает последнего сохранения время документа. Только для чтения.|1.3|
...
|[list](/javascript/api/word/word.list)|_Метод_ > setLevelAlignment (уровень: выравнивание номера: выравнивание)|Задает выравнивание маркера, номера или рисунка на указанном уровне списка.|1.3|
|[list](/javascript/api/word/word.list)|_Метод_ > setLevelBullet (уровень: число, listBullet: ListBullet charCode: число, fontName: строка)|Задает формат маркеров на указанном уровне списка. Если задан формат Custom, то параметр charCode является обязательным.|1.3|
|[list](/javascript/api/word/word.list)|_Метод_ > setLevelIndents (уровень: число, textIndent: число с плавающей запятой, textIndent: число с плавающей запятой)|Задает два отступа на указанном уровне списка.|1.3|
|[list](/javascript/api/word/word.list)|_Метод_ > setLevelNumbering (уровень: число, listNumbering: ListNumbering formatString: объектов)|Задает формат нумерации на указанном уровне списка.|1.3|
|[list](/javascript/api/word/word.list)|_Метод_ > setLevelStartingNumber (уровень: число, номер1: номер)|Задает начальный номер на указанном уровне списка. Значение по умолчанию: 1.|1.3|
...
|[paragraph](/javascript/api/word/word.paragraph)|_Метод_ > attachToList (listId: номер уровня: номер)|Позволяет присоединить абзац к существующему списку на указанном уровне. Если присоединить абзац к списку не удается или он уже является элементом списка, метод не выполняется.|1.3|
...
|[paragraph](/javascript/api/word/word.paragraph)|_Метод_ > getTextRanges (endingMarks: string, trimSpacing: bool)|Возвращает текстовые диапазоны абзаца с помощью знаков препинания и/или других маркеров конца.|1.3|
|[paragraph](/javascript/api/word/word.paragraph)|_Метод_ > insertTable (значение rowCount: число, columnCount: номеров, insertLocation: InsertLocation значения: строка)|Вставляет таблицу с указанным количеством строк и столбцов. Возможные значения insertLocation: Before и After.|1.3|
|[paragraph](/javascript/api/word/word.paragraph)|_Метод_ > Разделение (разделители: строка, trimDelimiters: bool trimSpacing: bool)|Разделяет абзац на дочерние диапазоны с помощью разделителей.|1.3|
...
|[paragraphCollection](/javascript/api/word/word.paragraphcollection)|_Метод_ > getLast()|Возвращает последний абзац в коллекции.|1.3|
...
|[range](/javascript/api/word/word.range)|_Метод_ > insertTable (значение rowCount: число, columnCount: номеров, insertLocation: InsertLocation значения: строка)|Вставляет таблицу с указанным количеством строк и столбцов. Возможные значения insertLocation: Before и After.|1.3|
...
|[range](/javascript/api/word/word.range)|_Метод_ > Разделение (разделители: строка, multiParagraphs: bool trimDelimiters: bool trimSpacing: bool)|Разделяет диапазон на дочерние диапазоны с помощью разделителей.|1.3|
...
|[requestContext](/javascript/api/word/word.requestcontext)|_Метод_ > нагрузки (объект: объект, параметр: объектов)|Заполняет объект прокси, созданный на уровне JavaScrypt, свойством и параметрами, которые указаны в параметре. |1.3|
...
|[table](/javascript/api/word/word.table)|_Метод_ > addColumns (insertLocation: InsertLocation, columnCount: числовые значения: строка)|Добавляет столбцы в начале или в конце таблицы, используя первый или последний из имеющихся столбцов в качестве шаблона. Применим к однородным таблицам. Строковые значения (если они указаны) добавляются в новые строки.|1.3|
|[table](/javascript/api/word/word.table)|_Метод_ > addRows (insertLocation: InsertLocation, rowCount: числовые значения: строка)|Добавляет строки в начале или в конце таблицы, используя первую или последнюю из имеющихся строк в качестве шаблона. Строковые значения (если они указаны) добавляются в новые строки.|1.3|
...
|[table](/javascript/api/word/word.table)|_Метод_ > deleteColumns (параметр columnIndex: число, columnCount: номер)|Удаляет определенные столбцы. Применим к однородным таблицам.|1.3|
|[table](/javascript/api/word/word.table)|_Метод_ > DeleteRows состоит из (rowIndex: число, rowCount: номер)|Удаляет определенные строки.|1.3|
...
|[table](/javascript/api/word/word.table)|_Метод_ > getCell (rowIndex: число, cellIndex: номер)|Возвращает ячейку таблицы в указанных строке и столбце.|1.3|
...
|[table](/javascript/api/word/word.table)|_Метод_ > insertTable (значение rowCount: число, columnCount: номеров, insertLocation: InsertLocation значения: строка)|Вставляет таблицу с указанным количеством строк и столбцов. Возможные значения insertLocation: Before и After.|1.3|
|[table](/javascript/api/word/word.table)|_Метод_ > поиска (searchText: строка, searchOptions: ParamTypeStrings.SearchOptions)|Выполняет поиск с помощью указанного объекта searchOptions в области объекта таблицы. Результат поиска — коллекция объектов диапазонов.|1.3|
...
|[table](/javascript/api/word/word.table)|_Метод_ > setCellPadding (cellPaddingLocation: CellPaddingLocation, cellPadding: число с плавающей запятой)|Задает размер поля ячейки в точках.|1.3|
...
|[tableCell](/javascript/api/word/word.tablecell)|_Метод_ > insertColumns (insertLocation: InsertLocation, columnCount: числовые значения: строка)|Добавляет столбцы слева или справа от ячейки, используя столбец этой ячейки в качестве шаблона. Применим к однородным таблицам. Строковые значения (если они указаны) добавляются в новые строки.|1.3|
|[tableCell](/javascript/api/word/word.tablecell)|_Метод_ > insertRows (insertLocation: InsertLocation, rowCount: числовые значения: строка)|Вставляет строки над ячейкой или под ней, используя строку этой ячейки в качестве шаблона. Строковые значения (если они указаны) добавляются в новые строки.|1.3|
|[tableCell](/javascript/api/word/word.tablecell)|_Метод_ > setCellPadding (cellPaddingLocation: CellPaddingLocation, cellPadding: число с плавающей запятой)|Задает размер поля ячейки в точках.|1.3|
...
|[tableRow](/javascript/api/word/word.tablerow)|_Метод_ > insertRows (insertLocation: InsertLocation, rowCount: числовые значения: строка)|Вставляет строки, используя данную строку в качестве шаблона. Если указаны значения, они вставляются в новые строки.|1.3|
|[tableRow](/javascript/api/word/word.tablerow)|_Метод_ > поиска (searchText: строка, searchOptions: ParamTypeStrings.SearchOptions)|Выполняет поиск с помощью указанного параметра searchOptions в области строки. Результат поиска — коллекция объектов диапазонов.|1.3|
...
|[tableRow](/javascript/api/word/word.tablerow)|_Метод_ > setCellPadding (cellPaddingLocation: CellPaddingLocation, cellPadding: число с плавающей запятой)|Задает размер поля ячейки в точках.|1.3|
...
|[inlinePicture](/javascript/api/word/word.inlinepicture)|_Метод_ > insertText (текст: string, insertLocation: InsertLocation)|Вставляет текст в заданном расположении. Возможные значения insertLocation: Before и After.|1.2|
