...
| [convertToLocalClientTime](#converttolocalclienttimetimevalue--localclienttimejavascriptapioutlook15officelocalclienttime) | Метод |
...
> [!NOTE]
> Возвращает недопустимое значение для клиентов Outlook на локальных установок Exchange 2016 связи или более поздняя версия настраиваемых REST URL-адрес, настроенных `restUrl`.
