...
> [!NOTE]
> Возвращает недопустимое значение для клиентов Outlook, подключенных к локальных установок Exchange 2016 настраиваемых REST URL-адрес, настроенных `restUrl`.
