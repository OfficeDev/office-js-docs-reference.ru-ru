...
- Добавлена [Office.EventType](office.md#eventtype-string): указывает событий, связанных с обработчиком событий и включает поддержку ItemChanged события.
...
- Добавлена [Office.context.ui.closeContainer](/javascript/api/office/office.ui#closecontainer--).
