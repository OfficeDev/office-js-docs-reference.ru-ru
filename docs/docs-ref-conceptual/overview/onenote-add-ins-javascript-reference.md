# <a name="onenote-javascript-api-overview"></a>Обзор OneNote JavaScript API

Область применения: OneNote Online

Ниже приведены ссылки на высокоуровневые объекты OneNote, доступные в API. Ссылки на страницы каждый объект содержит описание свойства, события и методы, доступные для объекта. Чтобы узнать больше, перейдите по ссылкам ниже. 
...
Подробные сведения о JavaScript API-интерфейса OneNote обратитесь к [Справочная документация по OneNote JavaScript API](/javascript/api/onenote).
