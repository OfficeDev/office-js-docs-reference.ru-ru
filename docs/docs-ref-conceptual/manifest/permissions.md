# <a name="permissions-element"></a><span data-ttu-id="0d519-101">Элемент Permissions</span><span class="sxs-lookup"><span data-stu-id="0d519-101">Permissions element</span></span>
