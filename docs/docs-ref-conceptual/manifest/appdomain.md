# <a name="appdomain-element"></a><span data-ttu-id="d530a-101">Элемент AppDomain</span><span class="sxs-lookup"><span data-stu-id="d530a-101">AppDomain element</span></span>
