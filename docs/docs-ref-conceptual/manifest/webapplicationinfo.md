# <a name="webapplicationinfo-element"></a><span data-ttu-id="47656-101">Элемент WebApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="47656-101">WebApplicationInfo element</span></span>
