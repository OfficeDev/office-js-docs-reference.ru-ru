...
- **CustomFunctions** - пользовательские функции, написанной на JavaScript для Excel.

[Пример кода в этой XML](https://github.com/OfficeDev/Excel-Custom-Functions/blob/master/customfunctions.xml) показано, как использовать элемент **ExtensionPoint** с значение атрибута **CustomFunctions** и дочерние элементы для использования.
...
> [!IMPORTANT] 
> Для элементов, содержащих атрибут ID убедитесь, что предоставление уникального идентификатора. Рекомендуем указать название компании и ваш идентификатор. Например, используйте следующий формат. <CustomTab id="mycompanyname.mygroupname">
