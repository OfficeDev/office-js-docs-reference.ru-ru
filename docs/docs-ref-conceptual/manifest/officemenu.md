# <a name="officemenu-element"></a><span data-ttu-id="d8c3a-101">Элемент OfficeMenu</span><span class="sxs-lookup"><span data-stu-id="d8c3a-101">OfficeMenu element</span></span>
