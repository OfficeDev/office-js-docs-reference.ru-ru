# <a name="officemenu-element"></a><span data-ttu-id="46f0f-101">Элемент OfficeMenu</span><span class="sxs-lookup"><span data-stu-id="46f0f-101">OfficeMenu element</span></span>
