# <a name="highresolutioniconurl-element"></a><span data-ttu-id="0f4c6-101">Элемент HighResolutionIconUrl</span><span class="sxs-lookup"><span data-stu-id="0f4c6-101">HighResolutionIconUrl element</span></span>
