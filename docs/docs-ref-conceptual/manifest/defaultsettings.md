# <a name="defaultsettings-element"></a><span data-ttu-id="a65ff-101">Элемент DefaultSettings</span><span class="sxs-lookup"><span data-stu-id="a65ff-101">DefaultSettings element</span></span>
