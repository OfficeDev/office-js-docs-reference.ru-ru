# <a name="customtab-element"></a><span data-ttu-id="c9d8c-101">Элемент CustomTab</span><span class="sxs-lookup"><span data-stu-id="c9d8c-101">CustomTab element</span></span>
