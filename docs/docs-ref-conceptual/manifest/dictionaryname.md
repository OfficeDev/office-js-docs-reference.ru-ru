# <a name="dictionaryname-element"></a><span data-ttu-id="c095c-101">Элемент DictionaryName</span><span class="sxs-lookup"><span data-stu-id="c095c-101">DictionaryName element</span></span>
