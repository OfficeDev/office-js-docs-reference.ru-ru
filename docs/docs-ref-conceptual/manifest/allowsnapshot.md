# <a name="allowsnapshot-element"></a><span data-ttu-id="2c13a-101">Элемент AllowSnapshot</span><span class="sxs-lookup"><span data-stu-id="2c13a-101">AllowSnapshot element</span></span>
