# <a name="mobileformfactor-element"></a><span data-ttu-id="4b9be-101">Элемент MobileFormFactor</span><span class="sxs-lookup"><span data-stu-id="4b9be-101">MobileFormFactor element</span></span>
