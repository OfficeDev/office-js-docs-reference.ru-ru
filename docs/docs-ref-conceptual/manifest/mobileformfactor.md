# <a name="mobileformfactor-element"></a><span data-ttu-id="9e62d-101">Элемент MobileFormFactor</span><span class="sxs-lookup"><span data-stu-id="9e62d-101">MobileFormFactor element</span></span>
