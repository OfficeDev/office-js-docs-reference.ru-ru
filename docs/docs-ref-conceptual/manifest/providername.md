# <a name="providername-element"></a><span data-ttu-id="c79dd-101">Элемент ProviderName</span><span class="sxs-lookup"><span data-stu-id="c79dd-101">ProviderName element</span></span>
