# <a name="sourcelocation-element"></a><span data-ttu-id="6ca2e-101">Элемент SourceLocation</span><span class="sxs-lookup"><span data-stu-id="6ca2e-101">SourceLocation element</span></span>
