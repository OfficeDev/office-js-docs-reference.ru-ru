...
> [!NOTE]
> Secure Sockets Layer (SSL) необходимо использовать для всех URL-адресов в элементах **изображения** и **URL-адрес** .
...
> [!IMPORTANT] 
> Outlook требуется возможность кэширования изображение ресурсов для повышения производительности. Поэтому сервер, на котором размещен ресурс изображения, не должен добавлять директивы CACHE-CONTROL в заголовок ответа. Это приведет к тому, что Outlook автоматически заменит универсальное или стандартное изображение.    
