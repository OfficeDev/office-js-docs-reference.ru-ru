# <a name="resources-element"></a><span data-ttu-id="4910a-101">Элемент Resources</span><span class="sxs-lookup"><span data-stu-id="4910a-101">Resources element</span></span>
