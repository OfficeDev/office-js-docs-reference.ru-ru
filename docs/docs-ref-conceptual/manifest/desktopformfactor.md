# <a name="desktopformfactor-element"></a><span data-ttu-id="7f03a-101">Элемент DesktopFormFactor</span><span class="sxs-lookup"><span data-stu-id="7f03a-101">DesktopFormFactor element</span></span>
