# <a name="getstarted-element"></a><span data-ttu-id="c7bdc-101">Элемент GetStarted</span><span class="sxs-lookup"><span data-stu-id="c7bdc-101">GetStarted element</span></span>
