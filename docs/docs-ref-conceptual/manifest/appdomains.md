# <a name="appdomains-element"></a><span data-ttu-id="4e4bf-101">Элемент AppDomains</span><span class="sxs-lookup"><span data-stu-id="4e4bf-101">AppDomains element</span></span>
