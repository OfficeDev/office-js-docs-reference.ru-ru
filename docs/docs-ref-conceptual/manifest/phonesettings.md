# <a name="phonesettings-element"></a><span data-ttu-id="68dbb-101">Элемент PhoneSettings</span><span class="sxs-lookup"><span data-stu-id="68dbb-101">PhoneSettings element</span></span>
