# <a name="defaultlocale-element"></a><span data-ttu-id="b4ae3-101">Элемент DefaultLocale</span><span class="sxs-lookup"><span data-stu-id="b4ae3-101">DefaultLocale element</span></span>
